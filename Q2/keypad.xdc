...
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { V16 }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
...
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { sys_rst_n }]; #IO_L9P_T1_DQS_14 Sch=btnc
...
set_property MARK_DEBUG true [get_nets E_IBUF]
set_property MARK_DEBUG true [get_nets B_OBUF]
set_property MARK_DEBUG true [get_nets {display[0]}]
set_property MARK_DEBUG true [get_nets F_IBUF]
set_property MARK_DEBUG true [get_nets G_IBUF]
set_property MARK_DEBUG true [get_nets A_OBUF]
set_property MARK_DEBUG true [get_nets C_OBUF]
set_property MARK_DEBUG true [get_nets D_OBUF]
set_property MARK_DEBUG true [get_nets {display[1]}]
set_property MARK_DEBUG true [get_nets {display[2]}]
set_property MARK_DEBUG true [get_nets {display[3]}]


set_property MARK_DEBUG true [get_nets sys_clk_IBUF_BUFG]
set_property MARK_DEBUG true [get_nets sys_clk_IBUF]
